...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerController_Move_m68BFC8B882D42955A212B23E7D1DDD56CC87DB09 (PlayerController_t7E8D7042FA2D0DFEC54A1FCDF395161D88DAAE95* __this, const RuntimeMethod* method) 
{
	...
	memset((&V_2), 0, sizeof(V_2));
	{
		...
		V_1 = L_1;
		bool L_2;
		L_2 = PlayerController_CheckIsGrounded_m3B732A3EAEE8DBE8A83304DF2B7C9F001A6B85A8(__this, NULL);
		if (!L_2)
		{
			goto IL_0037;
		}
	}
	{
		...
		Animator_SetTrigger_mC9CD54D627C8843EF6E159E167449D216EF6EB30(L_3, _stringLiteral3CD4100110E1F8AD3A2DE05E908276214F26A251, NULL);
		goto IL_003e;
	}
...
IL_003e:
	{
		bool L_4;
		L_4 = Input_GetKeyDown_mB237DEA6244132670D38990BAB77D813FBB028D2(((int32_t)304), NULL);
		if (!L_4)
		{
			goto IL_0086;
		}
	}
	{
		...
		Animator_SetBool_m6F8D4FAF0770CD4EC1F54406249785DE7391E42B(L_5, _stringLiteral8B75D8598E114A3064C3DB0902A6BC517966D395, (bool)1, NULL);
		float L_6 = __this->___moveSpeed;
		__this->___moveSpeed = ((float)il2cpp_codegen_add(L_6, (10.0f)));
		float L_7 = __this->___jumpForce;
		__this->___jumpForce = ((float)il2cpp_codegen_add(L_7, (1.0f)));
	}

IL_0086:
	{
		bool L_8;
		L_8 = Input_GetKeyUp_m9A962E395811A9901E7E05F267E198A533DBEF2F(((int32_t)304), NULL);
		if (!L_8)
		{
			goto IL_00ce;
		}
	}
	{
		...
		Animator_SetBool_m6F8D4FAF0770CD4EC1F54406249785DE7391E42B(L_9, _stringLiteral8B75D8598E114A3064C3DB0902A6BC517966D395, (bool)0, NULL);
		float L_10 = __this->___moveSpeed;
		__this->___moveSpeed = ((float)il2cpp_codegen_subtract(L_10, (10.0f)));
		float L_11 = __this->___jumpForce;
		__this->___jumpForce = ((float)il2cpp_codegen_subtract(L_11, (1.0f)));
	}
...
IL_0159:
	{
		...
		Animator_SetBool_m6F8D4FAF0770CD4EC1F54406249785DE7391E42B(L_38, _stringLiteral15C25B91D8FA3C30C0CFD33996BFCF8282A6D0D5, (bool)1, NULL);
		return;
	}
